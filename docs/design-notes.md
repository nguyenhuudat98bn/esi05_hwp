...
5. Bottom block (anchored bottom, gap 8): fine print "Free for 3 days, then ₫1,159,000 per year." 12 Medium `#94979C` centered; plans (padding 24h, gap 16):
   ...
   - Plan 2 (selected): bg `#F0F9FF`, border 1.5 `#2E90FA`; leading `CheckBox` 24 ø `#2E90FA` with white check; card title 14 Medium (Figma showed "Free trial enabled"; since the 3.1.2(c) rejection the title is the real offer — "3-day free trial / then <price> per year" or "<price> / year" — and only one card per period is shown, see `PaywallPlanVisibility.swift`); "Best Offer" ribbon 100×20 at top-right (x 186.5, y -12.5): gradient `#FF9966→#FF5E62`, top radius 20, text 10 Semibold white capitalized.
