...
internal enum Asset {
  internal enum Assets {
    internal enum App {
      ...
      internal static let imgConvertSuccess = ImageAsset(name: "App/img_convert_success")
      internal static let imgEmptyNoFiles = ImageAsset(name: "App/img_empty_no_files")
      internal static let imgHwpFile = ImageAsset(name: "App/img_hwp_file")
      internal static let imgImportWordBadge = ImageAsset(name: "App/img_import_word_badge")
      internal static let imgNoResultFound = ImageAsset(name: "App/img_no_result_found")
      ...
      internal static let imgPdfFile = ImageAsset(name: "App/img_pdf_file")
